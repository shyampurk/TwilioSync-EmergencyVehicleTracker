...
ambulance_list = [(37.754660, -122.399898),(37.754579, -122.401350),(37.754541, -122.402021),(37.754513, -122.402368),(37.754505, -122.402470),(37.754503, -122.402528),(37.754512, -122.402560),(37.754277, -122.406388)]
# create parser
...
while True:
	try:		
		for i in range(len(ambulance_list)):
			...
			if(i == len(ambulance_list)):
				time.sleep(10)
			if internet_on():		
				try:
					document = client.sync \
					    .services("ISd136efcec806480a96570a44a4b942af") \
					    .documents("gpsData") \
